...
import { UploadCloud, Activity, Leaf, AlertCircle, Clock, Shield, Sparkles, ChevronRight } from 'lucide-react';
    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8 animate-fade-in">
        <div className="flex items-center gap-3 mb-2">
          <div className="bg-gradient-to-br from-garden-500 to-teal-600 p-2.5 rounded-xl shadow-sm">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-2 text-center">
                  {preview ? (
                    <div className="flex flex-col items-center">
                      <img src={preview} alt="Preview" className="h-32 w-32 object-cover rounded-xl shadow-soft mb-2" />
                  ...
                  <label htmlFor="doctor-file-upload" className="relative cursor-pointer font-medium text-sm text-garden-600 hover:text-garden-700 transition-colors">
        ...
        {/* Results Panel */}
        {result ? (
          <div className="card-premium p-6 animate-slide-up border-garden-200/60">
            ...
            <div className="space-y-4">
              {/* Diagnosis */}
              <div className="bg-red-50/60 border border-red-100/60 p-5 rounded-2xl">
              ...
              {/* Treatment */}
              <div className="bg-blue-50/60 border border-blue-100/60 p-5 rounded-2xl">
          ...
          <div className="card-premium p-10 flex flex-col items-center justify-center text-center animate-fade-in">
            <div className="bg-garden-50 w-16 h-16 rounded-2xl flex items-center justify-center mb-4">
      ...
      {history.length > 0 && (
        <div className="mt-12 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          <div className="flex items-center gap-2 mb-5">
            ...
            <h3 className="text-lg font-bold text-gray-900">Recent Consultations</h3>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {history.map((record, i) => (
              ...
              >
                ...
                <h4 className="text-gray-900 font-bold text-sm mb-1.5 line-clamp-2">{record.diagnosis}</h4>
